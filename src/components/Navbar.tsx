...
export default function Navbar() {
  return (
<>
<Disclosure as="nav" className="fixed op-0 left-0 w-full z-50 
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
              <img alt="Your Company" src="https://media.licdn.com/dms/image/v2/C4D0BAQFdn6YBA6bFzw/company-logo_100_100/company-logo_100_100/0/1679132404053?e=1773273600&v=beta&t=CHJ2odpeLEVQazc-U7rFcZHblWo95n1_csu_SjSHFiU" className="h-8 w-auto"
              />
            </div>
